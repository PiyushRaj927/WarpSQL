...
then
    POSTGRESQL_SHARED_PRELOAD_LIBRARIES="citus,timescaledb,pg_repack,pgautofailover,hll"
else
    POSTGRESQL_SHARED_PRELOAD_LIBRARIES="citus,timescaledb,pg_repack,pgautofailover,hll,$POSTGRESQL_SHARED_PRELOAD_LIBRARIES"
fi
